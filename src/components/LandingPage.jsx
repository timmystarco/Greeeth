  ...
  return (
    <div className="bg-milkgreen flex justify-center">
      <div className="container flex flex-col items-center">
        ...
        <Facts />
        <div className="container flex items-center max-w-screen-xl rounded-3xl m-auto py-10 md:py-20 text-gray-600  md:px-12 xl:px-22  bg-lgreen w-full">
          <div className="space-y-6 md:space-y-0 px-4 lg:items-center w-full">
            <h1 className="text-3xl text-left sm:(text-5xl !leading-tight) font-medium capitalize text-white">
              Interactive map to explore
            </h1>
            <div className="mx-auto rounded-xl overflow-x-scroll w-full">
              <iframe
                className="mx-auto w-full sm:h-70vh h-50vh"
